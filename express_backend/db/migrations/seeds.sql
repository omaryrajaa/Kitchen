INSERT INTO customers(id, name, address, phone, email, password, address_latitude,address_longitude) VALUES
 (1, 'Elen', 'Cortana Ave', '6134440099', 'elenaCor@mail.com', '1234', 45.449493, -75.637611);
INSERT INTO customers(id, name, address, phone, email, password, address_latitude,address_longitude) VALUES
 (2, 'Ann', 'Guess Ave', '6134440022', 'AnnGues@mail.com', '4444', 45.449493, -75.737611);
INSERT INTO customers(id, name, address, phone, email, password, address_latitude,address_longitude) VALUES
 (3, 'Roze', 'Lablaws Ave', '6134440088', 'RozeLab@mail.com', '1777', 45.549493, -75.637611);
INSERT INTO customers(id, name, address, phone, email, password, address_latitude,address_longitude) VALUES
 (4, 'Zahra', 'Alice Str', '6134440011', 'ZahraAlc@mail.com', '0815', 45.349493, -75.437611);
INSERT INTO customers(id, name, address, phone, email, password, address_latitude,address_longitude) VALUES
 (5, 'Martin', 'Cheers Ave', '6134441111', 'MartinCh@mail.com', '6111', 44.449493, -76.637611);
SELECT nextval('customers_id_seq'::regclass);
ALTER SEQUENCE customers_id_seq RESTART WITH 6;
INSERT INTO caterers (id, first_name, last_name, address, phone, email, password, account_number, shop_name, shop_logo, address_latitude,address_longitude) VALUES
(1, 'Lawrence', 'Axe', 'Baltimore St', '6130006688', 'LawBalt@mail.com','1111', '123','happy shop', 'Image1',47.449493, -74.637611);
INSERT INTO caterers (id, first_name, last_name, address, phone, email, password, account_number, shop_name, shop_logo, address_latitude,address_longitude) VALUES
(2, 'Deen','Winchester', 'Grace St', '6130009999', 'DeenGrace@mail.com','2222','444','nice shop', 'Image2',47.449493, -76.637611);
INSERT INTO caterers (id, first_name, last_name, address, phone, email, password, account_number, shop_name, shop_logo, address_latitude,address_longitude) VALUES
(3, 'Marie','Joy', 'Van St', '6130001111', 'MarieVan@mail.com','3333', '333','hello shop', 'Image3',46.449493, -76.637611);
INSERT INTO caterers (id, first_name, last_name, address, phone, email, password, account_number, shop_name, shop_logo, address_latitude,address_longitude) VALUES
(4, 'Lara', 'Croft','Green St', '6130002233', 'LaraGreen@mail.com','4444', '578', 'grocery shop', 'Image1',47.449493, -75.937611);
