...
<CardContent>
<TextField id={`standard-basic-${props.id}`} label="Category"  value={values.category} name="category" onChange={handleChange}/>
...
<FormGroup>
      ...
      <FormControlLabel
        control={<Switch size="small" name="status" checked={values.status} onChange={toggleChecked} />}
        label="Today's Menu"
      />
