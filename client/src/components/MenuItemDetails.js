  ...
  return (
    <React.Fragment>  
      ...
      <Card className={classes.card}>
        <CardMedia image={food} title={item.title} className={classes.media} />
        <CardContent className={classes.content}>
          ...
          <CardActions >
            ...
            <Chip className={classes.chips} label="-" onClick={handleClickMinus} />
            <Typography>{quantity}</Typography>
            <Chip  className={classes.chips} label="+" onClick={handleClickPlus} />
        
        
        <Button onClick={(event) => handleClicAddCart(event, item, quantity)}>Add to Order</Button>
